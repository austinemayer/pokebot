...
*Clone the repospity:
    >   git clone git@github.com:Studnicky/pokebot.git
    >   cd pokebot    
...
## Adapters
    ...
    Pokebot is configured to use the slack adapter.
...
If you would like to change the adapter you will need to alter
